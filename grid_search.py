...
if __name__ == '__main__':
    ...
    for seed in Seed_set:
        ...
        loss_dc = [sum(i)/len(i) for i in LOSS_DCs]
        print('The best learning rate is: ', Learning_rates[loss_dc.index(min(loss_dc))])
